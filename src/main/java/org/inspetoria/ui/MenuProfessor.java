...
public class MenuProfessor {
    public static void menu(Scanner scanner) throws SQLException {
        ...
        do {
            try {
                ...
                switch (op) {
                    case 1 -> inserirProfessor(scanner, professorService);
                    case 2 -> listarProfessores(professorService);
                    case 3 -> editarProfessor(scanner, professorService);
                    case 4 -> excluirProfessor(scanner, professorService);
    ...
    private static void inserirProfessor(Scanner scanner, ProfessorService professorService) {
    ...
    private static void listarProfessores(ProfessorService professorService) {
    ...
    private static void editarProfessor(Scanner scanner, ProfessorService professorService) {
        listarProfessores(professorService);
    ...
    private static void excluirProfessor(Scanner scanner, ProfessorService professorService) {
